...
import { Settings as SettingsIcon, Palette, User, Bell, Shield, Monitor, Database, Calendar as CalendarIcon, RefreshCw, Link } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          ...
          {!['appearance', 'profile', 'calendar', 'data', 'preferences'].includes(activeSection) && (
            <FadeIn delay={100}>
              <div className="bg-theme-primary rounded-lg border border-gray-800 p-6">
